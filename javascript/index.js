...
if(menuLinks.length>0){
    ...
    if(iconMenu){
        iconMenu.addEventListener('click', function(e){
            // Добавляємо тегу БОДІ клас Лок щоб він не скролився 
    ...
    const swiper = new Swiper('.tables__wrapper', {
        // Optional parameters
    ...
    const swiper2 = new Swiper('.players__wrapper', {
               // Optional parameters
            direction: 'horizontal',
            loop: true,
               // Navigation arrows
